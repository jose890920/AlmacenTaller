...
Validaciones validaciones = new Validaciones();
    ...
    private void initComponents() {
        ...
        jPanel1.add(nombreProductoTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 170, -1));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 150, 240));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 440, 80));
        jPanel1.add(mensajeLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 24, 110, 30));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, -1, -1));
  ...
  validarSonido(validaciones.validarCampoVacio(nombreProductoTxt));
    ...
    private void descripcionTxtAreaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_descripcionTxtAreaFocusLost
        validarSonido(validaciones.validaTextArea(descripcionTxtArea));
    ...
    try {
       ...
       JOptionPane.showMessageDialog(null,facadeProducto.modificarProducto(mapearProducto()));
    ...
    try {
  nombreProductoTxt.setText("hola");
       Timer t = new Timer(2000, new ActionListener() {
           @Override
           public void actionPerformed(ActionEvent e) {
              nombreProductoTxt.setText("assa");
